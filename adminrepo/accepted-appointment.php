			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered" id="leaveTable"  style="width:100%;"> <thead> <tr> <th>#</th> <th> Appointment Number</th> <th>Name</th><th>Mobile Number</th> <th>Appointment Date</th><th>Appointment Time</th>
...
FROM 
	tblbook 
JOIN 
	tbluser ON tbluser.ID = tblbook.UserID 
WHERE 
	tblbook.Status = 'Selected' 
	AND NOT EXISTS (
		SELECT 1 
		FROM tblinvoice 
...
?>
                     ...
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
                                         <td><a href="view-appointment.php?viewid=<?php echo $row['bid'];?>" class="btn btn-primary fa fa-eye"></a></td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
				</div>
