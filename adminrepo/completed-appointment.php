...
JOIN 
    tblinvoice ON tblbook.AptNumber = tblinvoice.InvoiceAPTNumber 
WHERE 
...
?>
                         ...
                         <td><?php  echo $row['AptNumber'];?></td>
                          ...
                          <td><?php  echo $row['AptTime'];?>
                        </td><?php if($row['Status']==""){ ?>

                     <td class="font-w600"><?php echo "Not Updated Yet"; ?></td>
                     <?php } else { ?>
                      <td><?php  echo $row['Status'];?></td><?php } ?> 
					  <td><a href="view-invoice.php?invoiceid=<?php  echo $row['BillingId'];?>" class="btn btn-primary fa fa-eye"></a>
						 		</td>  </tr>   
<?php 
$cnt=$cnt+1;
}?></tbody> </table> 
