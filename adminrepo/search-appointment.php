...
<?php
$ret=mysqli_query($con,"select tbluser.FirstName,
tbluser.LastName,
tbluser.Email,
...
tblbook.BookingDate,
tblbook.Status 
from tblbook join tbluser 
on tbluser.ID=tblbook.UserID
where tblbook.AptNumber 
like '%$sdata%'  || tbluser.MobileNumber like '%$sdata%' || tbluser.FirstName like '%$sdata%' || tbluser.LastName like '%$sdata%'");
