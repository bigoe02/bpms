					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered"  id="leaveTable"  style="width:100%;"> 
						 ...
						 <td><?php  echo $row['FirstName'];?>
						  ...
						  <td><span class="badge badge-primary"><?php  echo $row['RegDate'];?></span></td> 
						  
						 	<td> <a href="customer-information.php?viewid=<?php echo $row['ID'];?>" class="btn btn-primary fa fa-id-card"></a>
									<a href="add-customer-services.php?addid=<?php echo $row['ID'];?>" class="btn btn-primary fa fa-check-square" style="background-color: orange;"></a>
						 		</td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
