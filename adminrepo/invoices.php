...
<?php
$ret=mysqli_query($con," select distinct tbluser.FirstName,
tbluser.LastName,
...
tblbook.AptNumber
 ...
 WHERE tblbook.AptNumber = tblinvoice.InvoiceAPTNumber
...
?>
						 ...
						 <tr> 
						 	...
						 	<td><?php  echo $row['invoicedate'];?></td> 
						 		<td><a href="view-invoice.php?invoiceid=<?php  echo $row['BillingId'];?>&aptId=<?php  echo $row['AptNumber'];?>" class="btn btn-primary">View</a>
						 		</td> 
