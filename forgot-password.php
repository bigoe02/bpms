...
?>
               ...
               <?php } ?> </div>
                ...
                <div class="container-login" style="width: 100%; height: 100%;">
                    <div class="brand-logo"style="background:url('assets/images/forgetpasswordlogo.png'); background-size: cover;"></div>
                    ...
                    <div class="twice-two">
                     ...
                     <div class="twice-two" style=" display: flex; justify-content: space-between;">
                     <div class="button-container" style="margin-top: 65px; ">
             
                    </div>
                        <button type="submit" class="btn btn-contact" name="submit" style="width: 40%;">Reset</button>
                        </div>
                    </form>
                </div>
            </div>
